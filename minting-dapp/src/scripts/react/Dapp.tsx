...
export default class Dapp extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          We were not able to detect <strong>MetaMask</strong>. Try opening the dApp <a href="https://metamask.app.link/dapp/classy-miami.pages.dev" target="_blank">in the MetaMask App.</a><br />
        </>,
      );
    }
